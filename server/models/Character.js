...
characterSchema.statics.calculateDerivedStats = function(character) {
  ...
  Object.entries(equippedSetIds).forEach(([setId, pieceCount]) => {
    ...
    if (setBonus) {
      console.log(`[calculateDerivedStats] Found bonus for ${setId}:`, JSON.stringify(setBonus));
      ...
      console.log(`[calculateDerivedStats] WARNING: No bonus found for set ${setId}`);
    }
  });
